...
// 		k1 := UTF8ToCP1252(k)
// 		//		v1 := UTF8ToCP1252(v)   // PIROGOM
// 		v1, _ := Utf8ToUtf16BE(v)
// 		d[k1] = StringLiteral(v1) //StringLiteral(v1) // PIROGOM
